# Campaign Simulation — Human User Guide
...
The framework is intentionally designed to start small.
...
For installation, commands, schemas, validation, and developer-facing details, continue to the main [README](README.md).
