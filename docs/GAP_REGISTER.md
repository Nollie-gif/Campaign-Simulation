...
| --- | --- | --- | --- |
| Prequel → Main convergence decision | Captures the explicit outcome at the canon boundary without granting a Main Campaign write | Prequel branch data repository | `templates/prequel-main-convergence.template.json` |
